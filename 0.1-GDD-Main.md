...
TRUTH_LINK: TRUTH_GDD-REVISION-LEDGER.md § REV_001, REV_003, REV_007
...
**Version:** 4.1
**Date:** 2026-06-13
**Related Documents:** [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md), [1.1-GDD-Core-Systems.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/1.1-GDD-Core-Systems.md), [3-GDD-Architecture-Coding.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/3-GDD-Architecture-Coding.md)
...
| **Cash** | Legacy term for currency. Now represented as a dual-currency system comprising trust-bound Electronic Credits and physical Specie commodity money. See **Electronic Credits** and **Physical Specie**. |
...
| **Conservation Axioms** | Five governing invariants (Matter, Population, Material Value, Thermodynamic Arrow, Causality) that constrain all simulation design intent. The live runtime enforces these qualitatively via tag propagation and bounded-occurrence loops rather than numeric bookkeeping. See [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) Section 1.3. |
| **Contact** | A Persistent Agent the player has met. Synonymous with Persistent Agent. |
| **Electronic Credits** | Trust-bound electronic ledger balances. Exists outside the matter-conservation budget (**TOTAL_MATTER**), clamps at zero (cannot go negative), and is transaction-routed based on faction affinity trust. See [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) Section 1.3. |
...
| **Faction** | A political/corporate entity. Factions issue electronic credits and dictate transaction trust based on their presence and sector tags. See [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) Section 1.3. |
...
| **Loyalty Points (LP)** | Per-faction contribution credit. Earned by faction work, spent on faction services. Finite and tracked. See [1-GDD-Core-Mechanics.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/1-GDD-Core-Mechanics.md) Section 6.2. |
...
| **Physical Specie** | Matter-backed cargo commodity currency (dense refined metal units). Counted in **TOTAL_MATTER** and used unconditionally by factionless agents or when transaction affinity is below the trust threshold. See [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) Section 1.3. |
...
| Commodities | 3–5 | Core trading goods (including physical Specie) |
