...
**Version:** 5.5
**Date:** 2026-06-13
**Related Documents:** [0.1-GDD-Main.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/0.1-GDD-Main.md) (v4.7), [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) (v2.5), [3-GDD-Architecture-Coding.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/3-GDD-Architecture-Coding.md) (v3.1)
...
* **Responsibility:** Stateless API for `GameState.characters`. Manage skills, player qualitative wealth tracks, standings, and reputation. (NPCs rely solely on status tags for simulation accounting; player uses qualitative wealth tracks).
* **Key API:** `gain_wealth_progress(uid, amount)`, `lose_wealth_progress(uid, amount)`, `get_wealth_tier(uid)`, `get_wealth_progress(uid)`, `get_skill_level(uid, skill_name)`.
...
├── faction_id: String
├── wealth_tier: String  # "Broke", "Comfortable", "Wealthy"
├── wealth_progress: int  # 0-10
