...
**Version:** 5.1
**Date:** 2026-06-13
**Related Documents:** [0.1-GDD-Main.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/0.1-GDD-Main.md) (v4.1), [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) (v2.1), [3-GDD-Architecture-Coding.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/3-GDD-Architecture-Coding.md) (v3.0)
...
* **Responsibility:** Stateless API for `GameState.characters`. Manage skills, electronic credits, faction/character standings, reputation, loyalty points.
* **Key API:** `add_credits(uid, amount)`, `subtract_credits(uid, amount)`, `get_credits(uid)`, `get_skill_level(uid, skill_name)`, `add_lp(uid, faction_id, amount)`, `get_lp(uid, faction_id)`.

> [!NOTE]
> **Currency Split Tracking:** While abstract electronic credits are managed directly via the Character System, physical specie (`commodity_specie`) is a tangible cargo commodity tracked through the [Inventory System](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/1.1-GDD-Core-Systems.md#L44) (System 4) in `GameState.inventories`, subject to standard cargo capacity constraints.
