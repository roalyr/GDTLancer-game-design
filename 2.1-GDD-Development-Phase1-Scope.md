...
**Version:** 2.4
**Date:** 2026-06-13
**Related Documents:** [0.1-GDD-Main.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/0.1-GDD-Main.md) (v4.7), [1.1-GDD-Core-Systems.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/1.1-GDD-Core-Systems.md) (v5.5), [8-GDD-Simulation-Architecture.md](file:///home/roalyr/Software_archive/Games/GDTLancer-game-design/8-GDD-Simulation-Architecture.md) (v2.5)
...
The player will:
* Start with a pre-owned ship, a starting Wealth Tier (Broke or Comfortable), and 0 progress on the active track.
* Engage with named **Contacts** at stations; build **Relationship** scores.
* Take faction goals affecting **Faction Standing**.
...
* Salvage disabled ships as repairable assets or strip them for salvage and equipment.
* Invest wealth progress in **Asset Progression** toward a second ship.
...
* [**Done**] Trading Module: contract-based cargo transport and delivery.
...
* [ ] Salvage system: disabled ships become wrecks, reclaimable as fleet assets or stripped for salvage/equipment.
* [ ] Asset Progression "Hangar" UI for investing wealth progress toward second ship.
...
* [ ] Balancing pass: Wealth progress rewards, Action Check difficulties.
