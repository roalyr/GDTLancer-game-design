...
--- Start of ./scenes/levels/sectors/sector_star_cob/planet_cob_a/planet_cob_a.tscn ---
...
[sub_resource type="ShaderMaterial" id=3]
shader = ExtResource( 2 )
shader_param/paint_color = Color( 0.933333, 0.913725, 0.607843, 1 )
...
[node name="Planet Cob a" type="StaticBody"]
...
light_color = Color( 0.364706, 0.490196, 0.568627, 1 )

--- Start of ./scenes/levels/sectors/sector_star_cob/sector_planet_cob_a.tscn ---
...
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=2]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_cob/planet_cob_a/planet_cob_a.tscn" type="PackedScene" id=4]
...
[node name="Sector Planet Cob a" type="Spatial"]
...
[node name="Planet Cob a" parent="SceneAssets" instance=ExtResource( 4 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_cob/sector_star_cob.tscn ---
...
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=2]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_cob/star_cob/star_cob.tscn" type="PackedScene" id=4]
...
[node name="Sector Star Cob" type="Spatial"]
...
--- Start of ./scenes/levels/sectors/sector_star_cob/star_cob/star_cob_sprite.tscn ---
...
shader = ExtResource( 2 )
shader_param/albedo = Color( 0.243137, 0.662745, 0.729412, 1 )
shader_param/scale_near = 2.0
shader_param/scale_peak = 2.0
shader_param/scale_far = 0.2
shader_param/peak_distance = 50000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 0.0
shader_param/fade_distance_far = 2e+06
...
shader_param/scale_near = 1.0
shader_param/scale_peak = 1.0
shader_param/scale_far = 0.1
shader_param/peak_distance = 15000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 0.0
shader_param/fade_distance_far = 2e+06
...
[node name="Star Cob Sprite" type="Spatial"]
...
--- Start of ./scenes/levels/sectors/sector_star_cob/star_cob/star_cob.tscn ---

[gd_scene load_steps=16 format=2]

[ext_resource path="res://assets/art/shaders/star_surface_NLP.gdshader" type="Shader" id=1]
[ext_resource path="res://scenes/levels/sectors/sector_star_cob/star_cob/star_cob_sprite.tscn" type="PackedScene" id=2]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 14 - 512x512.png" type="Texture" id=3]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=4]
...
shader_param/rim_color = Color( 0.219608, 0.219608, 0.219608, 1 )
shader_param/overlay_color = Color( 0.105882, 0.772549, 0.694118, 1 )
shader_param/surface_color = Color( 0.752941, 0.74902, 0.811765, 1 )
shader_param/fade_color = Color( 0.517647, 0.517647, 0.517647, 1 )
shader_param/major_phase = 0.95
shader_param/major_detail_intensity = 1.0
shader_param/major_detail_level = 0.5
shader_param/detail_decay_distance = 120000.0
...
shader_param/exponent_corona = 2.013
shader_param/exponent_corona_rim = 2.0
shader_param/corona_floor_power = 5.0
shader_param/corona_floor = 1.1535
shader_param/fade_distance_far = 15000.0
shader_param/fade_power = 6.0
shader_param/displacement_power = -0.03
...
shader_param/albedo = Color( 0.0666667, 0.196078, 0.207843, 1 )
shader_param/rim_strength = 5.0
shader_param/rim_exponent = 30.0
shader_param/rim_power = 0.642
shader_param/rim_floor = 0.578
shader_param/rim_outer_strength = 3.0
shader_param/rim_outer_exponent = 3.0
shader_param/fade_distance_near = 300000.0
shader_param/fade_distance_far = 800000.0
...
[node name="Model" type="Spatial" parent="."]
transform = Transform( 9928.58, 870.088, 816.263, -993.242, 9818.57, 1615.18, -660.922, -1684.72, 9834.86, 0, 0, 0 )
...
[node name="StarHalo" type="MeshInstance" parent="ModelAdditional"]
transform = Transform( 46408.9, 18594, -686.432, -18432, 45689.5, -8527.63, -2544, 8168.17, 49262.8, 0, 0, 0 )
material_override = SubResource( 5 )
mesh = SubResource( 6 )
skeleton = NodePath("../../Model")

[node name="Star Cob Sprite" parent="ModelAdditional" instance=ExtResource( 2 )]
...
--- Start of ./scenes/levels/sectors/sector_star_elace/moon_elace_a1/moon_elace_a1.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=1]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 1 - 512x512.png" type="Texture" id=2]
...
[ext_resource path="res://assets/art/shaders/simple_solid_NLP.gdshader" type="Shader" id=4]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/directional_light_elace.tscn" type="PackedScene" id=5]
...
[node name="DirectionalLightElace" parent="." instance=ExtResource( 5 )]

--- Start of ./scenes/levels/sectors/sector_star_elace/moon_elace_a2/moon_elace_a2.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 1 - 512x512.png" type="Texture" id=1]
...
shader_param/scale_min = 0.25
shader_param/detail_texture = ExtResource( 3 )
shader_param/normal_texture = ExtResource( 1 )

[sub_resource type="SphereMesh" id=2]

[node name="Moon Elace a2" type="StaticBody"]
...
--- Start of ./scenes/levels/sectors/sector_star_elace/moon_elace_c1/moon_elace_c1.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/bw_noise/Craters 14 - 512x512.png" type="Texture" id=1]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=2]
...
shader_param/scale_power = 1.0
shader_param/scale_min = 0.25
shader_param/detail_texture = ExtResource( 1 )
shader_param/normal_texture = ExtResource( 3 )

[sub_resource type="SphereMesh" id=2]

[node name="Moon Elace c1" type="StaticBody"]
...
--- Start of ./scenes/levels/sectors/sector_star_elace/planet_elace_a/planet_elace_a.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/bw_noise/Craters 14 - 512x512.png" type="Texture" id=1]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 1 - 512x512.png" type="Texture" id=2]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=3]
[ext_resource path="res://assets/art/shaders/simple_solid_NLP.gdshader" type="Shader" id=4]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/directional_light_elace.tscn" type="PackedScene" id=5]
...
[node name="DirectionalLightElace" type="DirectionalLight" parent="." instance=ExtResource( 5 )]
light_color = Color( 0.909804, 0.760784, 0.52549, 1 )

--- Start of ./scenes/levels/sectors/sector_star_elace/planet_elace_b/planet_elace_b.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/bw_noise/Craters 14 - 512x512.png" type="Texture" id=1]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/directional_light_elace.tscn" type="PackedScene" id=2]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=3]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 1 - 512x512.png" type="Texture" id=4]
[ext_resource path="res://assets/art/shaders/simple_solid_NLP.gdshader" type="Shader" id=5]
...
[node name="Planet Elace b" type="StaticBody"]
...
[node name="DirectionalLightElace" type="DirectionalLight" parent="." instance=ExtResource( 2 )]
light_color = Color( 0.909804, 0.760784, 0.52549, 1 )

--- Start of ./scenes/levels/sectors/sector_star_elace/planet_elace_c/planet_elace_c.tscn ---

[gd_scene load_steps=9 format=2]

[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/bw_noise/Craters 14 - 512x512.png" type="Texture" id=1]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 1 - 512x512.png" type="Texture" id=2]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/directional_light_elace.tscn" type="PackedScene" id=3]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=4]
[ext_resource path="res://assets/art/shaders/simple_solid_NLP.gdshader" type="Shader" id=5]
...
[node name="Planet Elace c" type="StaticBody"]
...
[node name="DirectionalLightElace" type="DirectionalLight" parent="." instance=ExtResource( 3 )]
light_color = Color( 0.909804, 0.760784, 0.52549, 1 )

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_moon_elace_a1.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/moon_elace_a1/moon_elace_a1.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Moon Elace a1" type="Spatial"]
...
[node name="Globalnebulas" parent="StarsphereSlot" instance=ExtResource( 7 )]
visible = false
...
[node name="Moon Elace a1" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_moon_elace_a2.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/moon_elace_a2/moon_elace_a2.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Moon Elace a2" type="Spatial"]
...
[node name="Moon Elace a2" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_moon_elace_c1.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/moon_elace_c1/moon_elace_c1.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Moon Elace c1" type="Spatial"]
...
[node name="Moon Elace c1" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_planet_elace_a.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/planet_elace_a/planet_elace_a.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Planet Elace a" type="Spatial"]
...
[node name="Planet Elace a" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_planet_elace_b.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/planet_elace_b/planet_elace_b.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Planet Elace b" type="Spatial"]
...
[node name="Planet Elace b" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_planet_elace_c.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://scenes/levels/sectors/sector_star_elace/planet_elace_c/planet_elace_c.tscn" type="PackedScene" id=1]
[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=5]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=6]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=7]
...
[node name="Sector Planet Elace c" type="Spatial"]
...
[node name="Planet Elace c" parent="SceneAssets" instance=ExtResource( 1 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_elace/sector_star_elace.tscn ---
...
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=2]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/star_elace.tscn" type="PackedScene" id=4]
...
[node name="Sector Star Elace" type="Spatial"]
...
--- Start of ./scenes/levels/sectors/sector_star_elace/star_elace/directional_light_elace.tscn ---

[gd_scene format=2]

[node name="DirectionalLightElace" type="DirectionalLight"]
light_color = Color( 0.909804, 0.760784, 0.52549, 1 )

--- Start of ./scenes/levels/sectors/sector_star_elace/star_elace/star_elace_sprite.tscn ---
...
shader = ExtResource( 2 )
shader_param/albedo = Color( 1, 1, 1, 1 )
shader_param/scale_near = 0.5
shader_param/scale_peak = 0.8
shader_param/scale_far = 0.07
shader_param/peak_distance = 50000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 0.0
...
--- Start of ./scenes/levels/sectors/sector_star_elace/star_elace/star_elace.tscn ---

[gd_scene load_steps=16 format=2]

[ext_resource path="res://assets/art/shaders/star_surface_NLP.gdshader" type="Shader" id=1]
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/star_elace_sprite.tscn" type="PackedScene" id=2]
[ext_resource path="res://assets/art/shaders/star_corona_NLP.gdshader" type="Shader" id=3]
[ext_resource path="res://src/core/utils/rotating_object.gd" type="Script" id=4]
[ext_resource path="res://assets/art/shaders/simple_glow_NLP.gdshader" type="Shader" id=5]
[ext_resource path="res://assets/art/textures/sbs-noise_texture_pack-512x512/normal_maps/Craters 14 - 512x512.png" type="Texture" id=6]
...
shader = ExtResource( 1 )
shader_param/rim_color = Color( 0.74902, 0.74902, 0.74902, 1 )
...
shader_param/scale_power = 1.0
shader_param/scale_min = 0.5
shader_param/major_detail_noise = ExtResource( 6 )
...
shader_param/strength_corona = 40.0
shader_param/exponent_corona = 1.8
shader_param/exponent_corona_rim = 2.0
shader_param/corona_floor_power = 5.0
shader_param/corona_floor = 1.3
shader_param/fade_distance_far = 5000.0
shader_param/fade_power = 6.0
shader_param/displacement_power = 0.06
shader_param/displacement_scale_xz = 0.85
shader_param/displacement_scale_y = 0.8
shader_param/displacement_velocity = 0.1
shader_param/scale_start = 100000.0
shader_param/scale_end_mul = 100.0
shader_param/scale_power = 1.0
...
[sub_resource type="ShaderMaterial" id=5]
shader = ExtResource( 5 )
shader_param/albedo = Color( 0.152941, 0.113725, 0.0627451, 1 )
shader_param/rim_strength = 5.0
shader_param/rim_exponent = 30.0
...
shader_param/fade_distance_far = 300000.0
shader_param/fade_power = 1.0
shader_param/scale_start = 100000.0
shader_param/scale_end_mul = 100.0
shader_param/scale_power = 1.0
...
[node name="StarHalo" type="MeshInstance" parent="ModelAdditional"]
transform = Transform( 27845.4, 11156.4, -411.861, -11059.2, 27413.7, -5116.57, -1526.4, 4900.9, 29557.6, 0, 0, 0 )
material_override = SubResource( 5 )
mesh = SubResource( 6 )
skeleton = NodePath("../../Model")
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/sector_planet_lywin_a.tscn ---
...
[node name="Planet Lywin a" type="StaticBody"]
...
[node name="DirectionalLight" type="DirectionalLight" parent="Model"]
transform = Transform( 0.001, 0, 0, 0, 0.001, 0, 0, 0, 0.001, 0, 0, 0 )
light_color = Color( 0.913725, 0.443137, 0.443137, 1 )

--- Start of ./scenes/levels/sectors/sector_star_lywin/sector_star_lywin_B.tscn ---

[gd_scene load_steps=7 format=2]

[ext_resource path="res://src/core/utils/editor_object.gd" type="Script" id=1]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=2]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_lywin/star_lywin_B/star_lywin_B.tscn" type="PackedScene" id=4]
...
[node name="Sector Star Lywin B" type="Spatial"]
...
[node name="Globalnebulas" parent="StarsphereSlot" instance=ExtResource( 2 )]
visible = false
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/sector_star_lywin_C.tscn ---
...
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=2]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_lywin/star_lywin_C/star_lywin_C.tscn" type="PackedScene" id=4]
...
[node name="Sector Star Lywin C" type="Spatial"]
...
[node name="Star Lywin C" parent="SceneAssets" instance=ExtResource( 4 )]

--- Start of ./scenes/levels/sectors/sector_star_lywin/sector_star_lywin_D.tscn ---
...
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=2]
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_lywin/star_lywin_D/star_lywin_D.tscn" type="PackedScene" id=4]
...
[node name="Sector Star Lywin D" type="Spatial"]
...
[node name="Star Lywin D" parent="SceneAssets" instance=ExtResource( 4 )]

--- Start of ./scenes/levels/sectors/sector_star_lywin/sector_star_lywin.tscn ---
...
[ext_resource path="res://src/scenes/game_world/starsphere_slot.gd" type="Script" id=2]
[ext_resource path="res://scenes/starspheres/global_nebulas_starsphere/global_nebulas.tscn" type="PackedScene" id=3]
[ext_resource path="res://scenes/levels/sectors/sector_star_lywin/star_lywin/star_lywin.tscn" type="PackedScene" id=8]
...
[node name="Sector Star Lywin" type="Spatial"]
...
[node name="Star Lywin" parent="SceneAssets" instance=ExtResource( 8 )]

[node name="EntryPoint" type="Spatial" parent="SceneAssets"]

--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin_B/star_lywin_B.tscn ---
...
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 15000.0
shader_param/fade_distance_far = 2e+06
shader_param/fade_power = 5.0
shader_param/intensity = 1.0
shader_param/exponent = 3.0
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin_C/star_lywin_C.tscn ---
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin_D/star_lywin_D.tscn ---
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin_E/star_lywin_E.tscn ---
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin/star_lywin_sprite.tscn ---
...
[sub_resource type="ShaderMaterial" id=1]
shader = ExtResource( 2 )
shader_param/albedo = Color( 0.254902, 0, 0, 1 )
shader_param/scale_near = 5.0
shader_param/scale_peak = 5.0
shader_param/scale_far = 0.2
shader_param/peak_distance = 5000.0
shader_param/fade_ratio = 10.0
shader_param/distance_power = 0.4
shader_param/fade_distance_near = 50.0
shader_param/fade_distance_far = 2e+06
shader_param/fade_power = 5.0
shader_param/intensity = 1.0
shader_param/exponent = 3.0
...
[sub_resource type="ShaderMaterial" id=2]
shader = ExtResource( 2 )
shader_param/albedo = Color( 0.67451, 0.607843, 0.666667, 1 )
shader_param/scale_near = 3.0
shader_param/scale_peak = 1.0
shader_param/scale_far = 0.1
shader_param/peak_distance = 5000.0
shader_param/fade_ratio = 10.0
...
[node name="Star Lywin Sprite" type="Spatial"]
...
--- Start of ./scenes/levels/sectors/sector_star_lywin/star_lywin/star_lywin.tscn ---
...
[node name="Star Lywin" type="StaticBody"]
...
[ext_resource path="res://scenes/levels/sectors/sector_star_elace/star_elace/star_elace_sprite.tscn" type="PackedScene" id=8]
...
[ext_resource path="res://scenes/levels/sectors/sector_star_lywin/star_lywin/star_lywin_sprite.tscn" type="PackedScene" id=11]
[ext_resource path="res://scenes/levels/sectors/sector_star_cob/star_cob/star_cob_sprite.tscn" type="PackedScene" id=12]
...
[node name="Star Lywin Sprite" parent="SectorStars (clipped by near plane which is 10u)" instance=ExtResource( 11 )]
transform = Transform( 1, 0, 0, 0, 1, 0, 0, 0, 1, 500000, -50000, 500000 )

[node name="Star Lywin B Sprite" parent="SectorStars (clipped by near plane which is 10u)" instance=ExtResource( 11 )]
transform = Transform( 1, 0, 0, 0, 1, 0, 0, 0, 1, 490000, -41000, 522000 )

[node name="Star Lywin C Sprite" parent="SectorStars (clipped by near plane which is 10u)" instance=ExtResource( 11 )]
transform = Transform( 1, 0, 0, 0, 1, 0, 0, 0, 1, 504000, -52000, 494000 )

[node name="Star Lywin D Sprite" parent="SectorStars (clipped by near plane which is 10u)" instance=ExtResource( 11 )]
transform = Transform( 1, 0, 0, 0, 1, 0, 0, 0, 1, 560100, -62000, 513000 )

[node name="Star Cob Sprite" parent="SectorStars (clipped by near plane which is 10u)" instance=ExtResource( 12 )]
transform = Transform( 1, 0, 0, 0, 1, 0, 0, 0, 1, -558000, 11000, 124800 )
...
[node name="LabelButtonInteract" type="Label" parent="ScreenControls/BottomCenterZone/ButtonInteract"]
anchor_left = 0.5
anchor_top = 0.5
anchor_right = 0.5
anchor_bottom = 0.5
...
[connection signal="pressed" from="ScreenControls/BottomCenterZone/ButtonInteract" to="." method="_on_ButtonInteract_pressed"]
...
[node name="BtnRunSilent" type="Button" parent="Panel/VBoxContainer/HeaderRow"]
margin_left = 1234.0
margin_right = 1494.0
margin_bottom = 150.0
rect_min_size = Vector2( 260, 0 )
theme = ExtResource( 3 )
text = "Run Raw Simulation"
...
--- Start of ./scenes/ui/menus/interaction_window/InteractionWindow.tscn ---

[gd_scene load_steps=3 format=2]

[ext_resource path="res://src/core/ui/interaction_window/interaction_window.gd" type="Script" id=1]
[ext_resource path="res://assets/themes/main_theme.tres" type="Theme" id=2]
...
[node name="LabelTargetName" type="Label" parent="Panel/VBoxContainer/HeaderRow"]
margin_right = 260.0
margin_bottom = 20.0
size_flags_horizontal = 3
text = "Target Name — Role"
...
[node name="LabelContextInfo" type="Label" parent="Panel/VBoxContainer"]
margin_top = 32.0
margin_right = 300.0
margin_bottom = 60.0
size_flags_vertical = 3
...
[node name="ActionButtons" type="VBoxContainer" parent="Panel/VBoxContainer"]
margin_top = 168.0
margin_right = 300.0
margin_bottom = 194.0
custom_constants/separation = 6

[node name="BtnTrade" type="Button" parent="Panel/VBoxContainer/ActionButtons"]
margin_right = 300.0
margin_bottom = 26.0
disabled = true
text = "Trade"

[node name="BtnCloseBottom" type="Button" parent="Panel/VBoxContainer"]
margin_top = 198.0
margin_right = 300.0
margin_bottom = 218.0
text = "Close"

[connection signal="pressed" from="Panel/VBoxContainer/HeaderRow/BtnClose" to="." method="_on_BtnClose_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/ActionButtons/BtnTrade" to="." method="_on_BtnTrade_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/BtnCloseBottom" to="." method="_on_BtnClose_pressed"]
...
--- Start of ./scenes/ui/menus/npc_trade_panel/NpcTradePanel.tscn ---

[gd_scene load_steps=3 format=2]

[ext_resource path="res://src/core/ui/npc_trade_panel/npc_trade_panel.gd" type="Script" id=1]
[ext_resource path="res://assets/themes/main_theme.tres" type="Theme" id=2]

[node name="NpcTradePanel" type="Control"]
anchor_right = 1.0
anchor_bottom = 1.0
mouse_filter = 2
theme = ExtResource( 2 )
...
[node name="LabelNpcName" type="Label" parent="Panel/VBoxContainer/HeaderRow"]
margin_right = 340.0
margin_bottom = 20.0
size_flags_horizontal = 3
text = "NPC Name — Role"
...
[node name="SectionNpcSide" type="HBoxContainer" parent="Panel/VBoxContainer"]
margin_top = 32.0
margin_right = 380.0
margin_bottom = 46.0

[node name="LabelNpcCargo" type="Label" parent="Panel/VBoxContainer/SectionNpcSide"]
margin_right = 188.0
margin_bottom = 14.0
size_flags_horizontal = 3
text = "Cargo: Empty"

[node name="LabelNpcCredits" type="Label" parent="Panel/VBoxContainer/SectionNpcSide"]
margin_left = 192.0
margin_right = 380.0
margin_bottom = 14.0
size_flags_horizontal = 3
...
[node name="SectionPlayerSide" type="HBoxContainer" parent="Panel/VBoxContainer"]
margin_top = 50.0
margin_right = 380.0
margin_bottom = 64.0

[node name="LabelPlayerCargo" type="Label" parent="Panel/VBoxContainer/SectionPlayerSide"]
margin_right = 188.0
margin_bottom = 14.0
size_flags_horizontal = 3
text = "Your Cargo: Empty"

[node name="LabelPlayerCredits" type="Label" parent="Panel/VBoxContainer/SectionPlayerSide"]
margin_left = 192.0
margin_right = 380.0
margin_bottom = 14.0
size_flags_horizontal = 3
text = "Your Credits: 0 cr"
...
[node name="LabelPaymentInstrument" type="Label" parent="Panel/VBoxContainer"]
margin_top = 172.0
margin_right = 380.0
margin_bottom = 186.0
...
[node name="LabelTradePrice" type="Label" parent="Panel/VBoxContainer"]
margin_top = 190.0
margin_right = 380.0
margin_bottom = 204.0
text = "Price: ~0 cr / 0 specie"
align = 1

[node name="HBoxButtons" type="HBoxContainer" parent="Panel/VBoxContainer"]
margin_top = 208.0
margin_right = 380.0
margin_bottom = 228.0
...
[node name="BtnBuyCargo" type="Button" parent="Panel/VBoxContainer/HBoxButtons"]
margin_left = 49.0
margin_right = 161.0
margin_bottom = 20.0
disabled = true
...
[node name="BtnSellCargo" type="Button" parent="Panel/VBoxContainer/HBoxButtons"]
margin_left = 181.0
margin_right = 293.0
margin_bottom = 20.0
disabled = true
...
[connection signal="pressed" from="Panel/VBoxContainer/HeaderRow/BtnClose" to="." method="_on_BtnClose_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/HBoxButtons/BtnBuyCargo" to="." method="_on_BtnBuyCargo_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/HBoxButtons/BtnSellCargo" to="." method="_on_BtnSellCargo_pressed"]
[connection signal="pressed" from="Panel/VBoxContainer/BtnCloseBottom" to="." method="_on_BtnClose_pressed"]
...
[node name="MarketSection" type="VBoxContainer" parent="Panel/VBoxContainer"]
visible = false
margin_top = 412.0
margin_right = 1446.0
margin_bottom = 600.0
...
[node name="LabelMarketHeader" type="Label" parent="Panel/VBoxContainer/MarketSection"]
margin_right = 1446.0
margin_bottom = 27.0
text = "Market (Lawful)"

[node name="ScrollContainer" type="ScrollContainer" parent="Panel/VBoxContainer/MarketSection"]
margin_top = 35.0
margin_right = 1446.0
margin_bottom = 188.0
size_flags_vertical = 3
...
[node name="MarketList" type="VBoxContainer" parent="Panel/VBoxContainer/MarketSection/ScrollContainer"]
margin_right = 1446.0
size_flags_horizontal = 3
custom_constants/separation = 6
